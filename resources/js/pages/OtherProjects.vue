<template>
  <Section titleUpper="Other" titleLower="Projects">
    <div class="section-body">
      <div class="projects-item">
        <div class="projects-body">
          <div class="columns is-vcentered">
            <div class="column is-hidden-mobile">
              <img src="/images/wards.jpg" alt="wards" />
            </div>
            <div class="column is-three-quarters">
              <div class="project">
                ...
                <p>
                  ...
                  was to create an external applet which integrates with one of
                  our existing applications. I worked as developer on our team,
                  ...
                  further as something we can develop into a full product.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="projects-item">
        <div class="projects-body">
          <div class="columns is-vcentered">
            ...
            <div class="column is-hidden-mobile">
              <img src="/images/gloomhaven.jpg" alt="Gloomhaven" />
            </div>
          </div>
        </div>
      </div>
      <div class="projects-item">
        <div class="projects-body">
          <div class="columns is-vcentered">
            <div class="column is-hidden-mobile">
              <img src="/images/portalstories.jpg" alt="portal" />
            </div>
            <div class="column is-three-quarters">
              <div class="project">
                ...
                <p>
                  ...
                  the mod for my past contributions.
                </p>
                <div class="level">
                  <div class="level-item">
                    <a
      ...
      <div class="projects-item">
        <div class="projects-body">
          <div class="columns is-vcentered">
            <div class="column is-hidden-mobile">
              <img src="/images/albumart.jpg" alt="MoreThanData" />
            </div>
            <div class="column is-three-quarters">
              <div class="project">
      ...
      <div class="projects-item">
        <div class="projects-body">
          <div class="columns is-vcentered">
            ...
            <div class="column is-hidden-mobile">
              <img src="/images/justgiving.jpg" alt="JustGiving" />
            </div>
          </div>
        </div>
      </div>
