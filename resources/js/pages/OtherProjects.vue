        ...
        <div class="level">
          <div class="level-item">
            <div class="tags">
              ...
              <span class="tag">MosaicJS (Bespoke Framework)</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="slide">
      ...
      <div class="container">
        ...
        <p>
          ...
          from <a href="./v1">V1</a>, to make it far more readable, and easy to follow. I have used Fullpage.JS to draw attention to each
      ...
      <div class="level">
        <div class="level-item">
          <div class="tags">
            ...
            <span class="tag">Fullpage.js</span>
          </div>
        </div>
      </div>
    </div>
